...
namespace OrthogonalComponentHsm
{
    ...
    public class MainForm : System.Windows.Forms.Form
    {
        ...
        private void buttonStart_Click(object sender, System.EventArgs e)
        {
            ...
            AlarmClock.Instance.DisplayAlarmTime += new AlarmClock.AlarmDisplayHandler(
                UpdateAlarmTime
            );
            AlarmClock.Instance.DisplayTimeOfDay += new AlarmClock.AlarmDisplayHandler(
                UpdateTimeOfDay
            );
            AlarmClock.Instance.DisplayAlarmAlert += new AlarmClock.AlarmDisplayHandler(
                ShowAlarmPicture
            );
        ...
        private void UpdateTimeOfDay(object sender, AlarmClockEventArgs e)
        {
            ...
            {
                AlarmClock.AlarmDisplayHandler alarmDisplayHandler =
