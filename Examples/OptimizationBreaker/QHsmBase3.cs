	...
	public class QHsmBase3 : QHsm 
	{
		...
		protected QState s01(IQEvent qEvent)
		{
			switch (qEvent.QSignal)
			{
				...
				case (int)MyQSignals.Sig1:  Console.Write("s01-Sig1;");  TransitionTo(m_s02, s_TranIdx_s01_s02);   return null;
			} 
			return m_s0;
		}
		...
		protected virtual QState s02(IQEvent qEvent)
		{
			switch (qEvent.QSignal)
			{
				...
				case (int)MyQSignals.Sig2:  Console.Write("s02-Sig2;");  TransitionTo(m_s01, s_TranIdx_s02_s01);   return null;
			} 
			return m_s0;
		}
	}
