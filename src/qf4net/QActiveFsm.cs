...
{
    public QActiveFsm(IQEventBroker eventBroker = null, StatemachineConfig fsmConfig = null)
        : base(fsmConfig)
    {
    ...
    public void RunEventPump(int priority, CancellationToken cancellationToken = default) => _eventPump.RunEventPump(priority, cancellationToken);
