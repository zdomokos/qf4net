...
public class MainForm : Form
{
    ...
    private TextBox     textBoxPollingCtr;
    private Label       labelPollingCtr;
    private TextBox     textBoxProcessingCtr;
    private Label       labelProcessingCtr;
    private System.ComponentModel.IContainer components;

    private void buttonStop_Click(object sender, EventArgs e)
    {
        DispatchMessage(QSignals.Terminate);
    }
    ...
    private MainForm()
    {
        ...
        Reminder.Instance.DisplayState += UpdateReminderStatus;
        Reminder.Instance.DisplayPoll += UpdatePollStatus;
        Reminder.Instance.DisplayProc += UpdateProcStatus;
    }
